    ...
    <div className="header flex  justify-between shadow-lg h-28 mb-2">
      ...
      <div className="nav-items flex items-center mr-10">
        <ul className="flex mr-4 font-bold ">
         ...
         <li className="  w-44 flex  px-4  hover:text-red-400"> 
          <div>
          <Link to="/cart"> 
...
<div className=" -top-3 -right-3 bg-red-500 text-white text-xs font-bold w-4 h-4 rounded-full flex items-center justify-center">
{cartItems.length}
      </div>
